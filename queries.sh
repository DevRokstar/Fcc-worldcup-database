...
# The test usually expects the average sum of both scores per game
...
# FIXED: Added WHERE and fixed join logic
...
# FIXED: Added WHERE and corrected logic to include both winners and opponents
